    ...
    public class ApplicationRepository : IApplicationRepository
    {
        ...
        public IEnumerable<ApplicationSubmission> Get()
        {
            ...
            return _dbContext.ApplicationSubmissions
                        ...
                        .Include(a => a.PieceRateWageInfo.SCAWageDeterminationAttachment).Include(a => a.PieceRateWageInfo.Attachment)
                        .Include(a => a.HourlyWageInfo.MostRecentPrevailingWageSurvey.Attachment).Include(a => a.HourlyWageInfo.Attachment)
