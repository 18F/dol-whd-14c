...
namespace DOL.WHD.Section14c.Test.RepositoryMocks
{
    public class ErrorLogRepositoryMock: IErrorLogRepository
    {
        ...
        public ErrorLogRepositoryMock()
        {
            ...
            {
                new APIErrorLogs {Id=1, EIN = "12-1234567", Exception = "My Test Exception 1", Level = "Fatal", Message="This a test message", User="test@test.com", UserId="12345"},
                new APIErrorLogs {Id=2, EIN = "12-2234567", Exception = "My Test Exception 2", Level = "Error", Message="This a test message", User="test2@test.com", UserId="22345"},
                new APIErrorLogs {Id=3, EIN = "12-3234567", Exception = "My Test Exception 3", Level = "Warn", Message="This a test message", User="test3@test.com", UserId="32345"},
                new APIErrorLogs {Id=4, EIN = "12-4234567", Exception = "My Test Exception 4", Level = "Info", Message="This a test message", User="test4@test.com", UserId="42345"},
                new APIErrorLogs {Id=5, EIN = "12-5234567", Exception = "My Test Exception 5", Level = "Debug", Message="This a test message", User="test5@test.com", UserId="52345"},
                new APIErrorLogs {Id=6, EIN = "12-6234567", Exception = "My Test Exception 6", Level = "Trace", Message="This a test message", User="test6@test.com", UserId="62345"},
            };
        }
