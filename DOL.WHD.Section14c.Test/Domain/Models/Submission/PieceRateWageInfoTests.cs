    ...
    public class PieceRateWageInfoTests
    {
        ...
        public void PieceRateWageInfo_PublicProperties()
        {
            ...
            var model = new PieceRateWageInfo
            {
                ...
                SCAAttachments = new List<WageTypeInfoSCAAttachment>() { new WageTypeInfoSCAAttachment() { SCAAttachment = scaWageDetermination } },
            ...
            Assert.AreEqual(scaWageDetermination, model.SCAAttachments.FirstOrDefault().SCAAttachment);
