...
We test using Web Content Accessibility Guidelines 2.0 AA (WCAG 2.0 AA) standards using [pa11y](https://github.com/pa11y/pa11y) for automated scans and [AXE](https://www.deque.com/blog/google-selects-deques-axe-chrome-devtools/) with the [DHS Trusted Tester Program (TT)](https://www.dhs.gov/trusted-tester) process for manual scans. For each, our acceptable quality level is zero errors reported. If errors are found, they should be addressed before a story is marked as complete.
