describe('validationService', function() {
    ...
    it('should set and clear validation error', function() {
        ...
        expect(validationService.getValidationError("error.prop.path")).toEqual("ERROR");

        validationService.clearValidationError("error.prop.path");
        expect(validationService.getValidationError("error.prop.path")).toBe(undefined);
    });

    it('should check required value', function() {
        // test value equals
        expect(validationService.checkRequiredValue("employer.numSubminimalWageWorkers.total")).toEqual(5);
    ...
    it('should check required number', function() {
        // test value equals
        expect(validationService.checkRequiredNumber("employer.numSubminimalWageWorkers.total")).toEqual(5);

        // test failure when value is < min
        expect(validationService.checkRequiredNumber("employer.numSubminimalWageWorkers.total", undefined, 10)).toBeUndefined();

        // test failure when value is > max
        expect(validationService.checkRequiredNumber("employer.numSubminimalWageWorkers.total", undefined, 0, 2)).toBeUndefined();
    ...
    it('should check required multiple choice', function() {
        // test value exists
        expect(validationService.checkRequiredMultipleChoice("applicationType")).toBeDefined();

        // test invalid property
        expect(validationService.checkRequiredMultipleChoice("bogus")).toBeUndefined();
        expect(validationService.getValidationError("bogus")).toBeDefined();
    });
    ...
    it('should validate a telephone number', function() {
        expect(validationService.validateTelephoneNumber("333-444-5555")).toBe(true);
    });

    it('should validate an email address', function() {
        expect(validationService.validateEmailAddress("email@email.com")).toBe(true);
    });
