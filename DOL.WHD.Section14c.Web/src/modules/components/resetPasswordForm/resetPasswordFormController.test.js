describe('resetPasswordFormController', function() {
    ...
    beforeEach(inject(function ($rootScope, $controller, _$q_, $location, apiService, stateService) {
        scope = $rootScope.$new();
        $q = _$q_;
        ...
        spyOn(mockApiService, 'resetPassword').and.returnValue(resetPassword.promise);
        
        verifyResetPassword = $q.defer();
        spyOn(mockApiService, 'verifyResetPassword').and.returnValue(verifyResetPassword.promise);
