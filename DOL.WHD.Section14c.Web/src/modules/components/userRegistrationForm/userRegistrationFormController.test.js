describe('userRegistrationFormController', function() {
    ...
    beforeEach(inject(function ($rootScope, $controller, _$q_, apiService, vcRecaptchaService, $location) {
        $q = _$q_;
        scope = $rootScope.$new();
        ...
        spyOn(mockapiService, 'emailVerification').and.returnValue(emailVerification.promise);
    ...
    it('submitting registration has an error, EIN is already registered message is displayed', function() {
        ...
        scope.onSubmitClick();
        scope.resetRegCaptcha = function() {};
        userRegister.reject({data: {"modelState":{"error":[ "EIN is already registered"] }}});
        scope.$apply();
    ...
    it('submitting registration has an error, Unable to validate reCaptcha Response message is displayed', function() {
        ...
        scope.onSubmitClick();
        scope.resetRegCaptcha = function() {};
        userRegister.reject({data: {"modelState":{"error":[ "Unable to validate reCaptcha Response"] }}});
        scope.$apply();
    ...
    it('submitting registration has an error, Username already taken message is displayed', function() {
        ...
        scope.onSubmitClick();
        scope.resetRegCaptcha = function() {};
        userRegister.reject({data: {"modelState":{"error":[ "is already taken"] }}});
        scope.$apply();
    ...
    it('submitting registration has an error, The Email field is required message is displayed', function() {
        ...
        scope.onSubmitClick();
        scope.resetRegCaptcha = function() {};
        userRegister.reject({data: {"modelState":{"error":[ "The Email field is required."] }}});
        scope.$apply();
    ...
    it('submitting registration has an error, The Password field is required. message is displayed', function() {
        ...
        scope.onSubmitClick();
        scope.resetRegCaptcha = function() {};
        userRegister.reject({data: {"modelState":{"error":[ "The Password field is required."] }}});
        scope.$apply();
    ...
    it('submitting registration has an error, The EIN field is required. message is displayed', function() {
        ...
        scope.onSubmitClick();
        scope.resetRegCaptcha = function() {};
        userRegister.reject({data: {"modelState":{"error":[ "The EIN field is required."] }}});
        scope.$apply();
    ...
    it('submitting registration has an error, The field EIN must match message is displayed', function() {
        ...
        scope.onSubmitClick();
        scope.resetRegCaptcha = function() {};
        userRegister.reject({data: {"modelState":{"error":[ "The field EIN must match"] }}});
        scope.$apply();
    ...
    it('submitting registration has an error, The password and confirmation password do not match. message is displayed', function() {
        ...
        scope.onSubmitClick();
        scope.resetRegCaptcha = function() {};
        userRegister.reject({data: {"modelState":{"error":[ "The password and confirmation password do not match."] }}});
        scope.$apply();
    ...
    it('submitting registration has an error, Password does not meet complexity requirements. message is displayed', function() {
        ...
        scope.onSubmitClick();
        scope.resetRegCaptcha = function() {};
        userRegister.reject({data: {"modelState":{"error":[ "Password does not meet complexity requirements."] }}});
        scope.$apply();
    ...
    it('call email verification when code and userId are present', function() {
        spyOn(mockLocation, 'search').and.returnValue({ code: 'code', userId: 'userId'});
        var controller = userRegistrationFormController();
        scope.$apply();
