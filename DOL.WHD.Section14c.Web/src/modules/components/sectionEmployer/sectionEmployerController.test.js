describe('sectionEmployerController', function() {
    ...
    it('toggleDeductionType toggle on', function() {
        ...
        expect(scope.formData.employer.providingFacilitiesDeductionTypeId.indexOf(1)).toBe(0)
    });
    ...
    it('toggleDeductionType toggle off', function() {
        ...
        expect(scope.formData.employer.providingFacilitiesDeductionTypeId.indexOf(1)).toBe(-1)
    });          
});